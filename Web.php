<?php
  ...
  // siapkan query untuk menampilkan seluruh data dari tabel produk
    $query  = "SELECT products.PRODUCT_ID AS id_produk, products.PRODUCT_NAME as nama_produk, COUNT(warehouse_log.PRODUCT_ID) AS jumlah ";
    $query .= "FROM products LEFT JOIN warehouse_log ON products.PRODUCT_ID = warehouse_log.PRODUCT_ID ";
    $query .= "GROUP BY products.PRODUCT_ID ORDER BY products.PRODUCT_ID ASC LIMIT $mulai,$baris";
}
?>
<!DOCTYPE html>
<html>
